...
def on_setup_editor_buttons(buttons, editor):
    ...
    # The IO dialog embeds Anki's real Editor for its HTML-capable fields.
    # Adding the IO launcher to that nested editor would recursively open a
    # second IO dialog and is not part of the field-editing surface.
    if getattr(editor, "is_imgocc_embedded_editor", False):
        return buttons
